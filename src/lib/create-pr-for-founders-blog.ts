/**
 * Script to create the "How Founders Can Use PR to Explode Early-Stage Growth" blog post
 * Run this from the admin dashboard console
 */

import { supabase } from "./supabaseClient";
import { calculateSEOScore } from "./blog-seo";

// Existing blog post slugs for internal linking
...
function addInternalLinks(content: string): string {
  ...
  // Add links to existing blog posts where relevant
  const linkMap: { [key: string]: string } = {
    "press pitch examples": "/blog/press-pitch-examples-that-get-replies",
    "Press Pitch Examples": "/blog/press-pitch-examples-that-get-replies",
    "pitch examples": "/blog/press-pitch-examples-that-get-replies",
    "fastest ways to get press": "/blog/the-fastest-ways-to-get-press-coverage-without-an-agency",
    "get press without an agency": "/blog/the-fastest-ways-to-get-press-coverage-without-an-agency",
    "get press coverage without an agency": "/blog/the-fastest-ways-to-get-press-coverage-without-an-agency",
    "pitch journalists on Twitter": "/blog/how-to-pitch-journalists-on-twitter",
    "pitch journalists on twitter": "/blog/how-to-pitch-journalists-on-twitter",
    "best platforms for contacting journalists": "/blog/ultimate-guide-best-platforms-contacting-journalists-2026",
    "platforms for contacting journalists": "/blog/ultimate-guide-best-platforms-contacting-journalists-2026",
  };
  
  // Add links (case-insensitive, whole word matching where possible)
  for (const [phrase, url] of Object.entries(linkMap)) {
    const regex = new RegExp(`(${phrase.replace(/[.*+?^${}()|[\]\\]/g, '\\$&')})`, 'gi');
    linkedContent = linkedContent.replace(regex, (match) => {
      // Don't replace if already inside a link
      const before = linkedContent.substring(0, linkedContent.indexOf(match));
      const after = linkedContent.substring(linkedContent.indexOf(match) + match.length);
      if (before.includes('<a') && !before.split('<a').pop()?.includes('</a>')) {
        return match; // Already inside a link
      }
      return `<a href="${url}" class="text-accent-blue hover:text-accent-violet font-semibold">${match}</a>`;
    });
  }
...
<div class="prose prose-invert prose-lg max-w-none">
  <p class="text-xl text-slate-300 mb-8 leading-relaxed">
    PR for Founders: A Practical Guide to Getting Press Without an Agency
  </p>
  ...
  <div class="bg-accent-blue/10 border border-accent-blue/30 rounded-lg p-6 my-8">
    ...
    <p class="text-slate-200 mb-4">
      If you're a founder or solopreneur trying to get press without a PR agency, ContactJournalists.com is built for you.
    </p>
    <p class="text-slate-200 mb-4">
      Here's what you get:
    </p>
    <ul class="text-slate-200 mb-4 list-disc list-inside space-y-2">
  ...
  <ul class="text-slate-300 mb-8 space-y-2">
    <li><a href="#why-pr-misunderstood" class="text-accent-blue hover:text-accent-violet">Why PR Is the Most Misunderstood Growth Lever for Early-Stage Founders</a></li>
    <li><a href="#what-works" class="text-accent-blue hover:text-accent-violet">What Actually Works in Early-Stage PR (and What Doesn't)</a></li>
    <li><a href="#how-founders-get-press" class="text-accent-blue hover:text-accent-violet">How Founders Can Get Press Without a PR Agency</a></li>
    <li><a href="#evergreen-pr" class="text-accent-blue hover:text-accent-violet">Evergreen PR: How Press Coverage Drives Traffic for Years</a></li>
    <li><a href="#common-questions" class="text-accent-blue hover:text-accent-violet">PR for Founders: Common Questions</a></li>
  </ul>

  <section id="why-pr-misunderstood" class="mb-16">
    <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">Part 1: Why PR Is the Most Misunderstood Growth Lever for Early-Stage Founders</h2>
    
    <h3 class="text-2xl font-semibold text-white mb-4">From One Founder to Another</h3>
    ...
    <div class="flex flex-col md:flex-row gap-6 mb-6 items-start">
      ...
      <div class="flex-1">
        <p class="text-slate-300 mb-4">
          Hello, I'm <strong>Fortuna</strong>, the founder of ContactJournalists.com.
        </p>
        <p class="text-slate-300 mb-4">
          Before building ContactJournalists, back in 2015 I founded a hair supplement brand called <a href="https://www.itreallyworksvitamins.com" class="text-accent-blue hover:text-accent-violet font-semibold" target="_blank" rel="noopener noreferrer">ItReallyWorksVitamins.com</a>. I didn't raise money. I didn't have a big team. I didn't have a PR agency on retainer. I built it myself, slowly, through trial and error.
        </p>
        <p class="text-slate-300 mb-4">
          For seven years!!
        </p>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">I Know Exactly What You're Going Through</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">Why Most Founders Get PR Completely Wrong</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">The Attention Problem No One Talks About</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">PR Is Not About Ego. It's About Distribution.</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">Learning the Hard Way: Trial, Error, and Clarity</h3>
    ...
    <p class="text-slate-300 mb-6 font-semibold">
    ...
    <div class="bg-accent-violet/10 border border-accent-violet/30 rounded-lg p-6 my-8">
      <p class="text-slate-200 mb-4">
        Want to save yourself a lot of stress? Try <a href="/waitlist-signup" class="text-accent-blue hover:text-accent-violet font-semibold">ContactJournalists.com 7 day free trial</a> and let us do the hard work for you!
      </p>
    </div>

    <h3 class="text-2xl font-semibold text-white mb-4">Standing Out Is About Precision, Not Volume</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">Why I Built ContactJournalists.com</h3>
    ...
    <p class="text-slate-300 mb-6">
      I didn't want outdated media lists. I didn't want PR theory. I didn't want agency fluff.
    </p>
    ...
    <p class="text-slate-300 mb-6">
      Solve those three things, and PR becomes one of the most powerful growth levers available to an early-stage business. <a href="/waitlist-signup" class="text-accent-blue hover:text-accent-violet font-semibold">Start your 7 Day Free Trial Now!</a>
    </p>

    <h3 class="text-2xl font-semibold text-white mb-4">What This Guide Is (and Isn't)</h3>

    <p class="text-slate-300 mb-6">
      This isn't written from the perspective of a PR agency. It's written from one founder to another.
    </p>
  ...
  <section id="what-works" class="mb-16">
    <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">Part 2: What Actually Works in Early-Stage PR (and What Doesn't)</h2>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">First, a Hard Truth Most Founders Need to Hear</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">The Journalist's Question You Must Answer Instantly</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">Why Timing Beats Brilliance</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">The Myth of the Perfect Pitch</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">Relevance Is Narrower Than You Think</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">Why "We're Launching" Is a Weak Angle</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">Opinion Beats Features</h3>
    ...
    <div class="bg-accent-blue/10 border border-accent-blue/30 rounded-lg p-6 my-8">
      <p class="text-slate-200 mb-4">
        If you want to try this properly without overthinking it, <a href="/waitlist-signup" class="text-accent-blue hover:text-accent-violet font-semibold">start your 7-day free trial of ContactJournalists.com</a>. We're confident you'll love it.
      </p>
    </div>

    <h3 class="text-2xl font-semibold text-white mb-4">Speed Is a Hidden Advantage for Solopreneurs</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">When Not to Pitch (This Is Important)</h3>
    ...
    <p class="text-slate-300 mb-6">
      If you're stretching relevance, don't send it. If you're forcing an angle, don't send it. If you have to explain why you might fit, you probably don't.
    </p>
    ...
    <p class="text-slate-300 mb-6">
      I responded in the same spirit, introducing It Really Works Vitamins, rather than forcing a polished brand pitch and 6 months later, we were featured in Forbes! <a href="https://www.forbes.com/sites/leebelltech/2019/04/27/best-nutrition-innovation-2019/" class="text-accent-blue hover:text-accent-violet font-semibold" target="_blank" rel="noopener noreferrer">https://www.forbes.com/sites/leebelltech/2019/04/27/best-nutrition-innovation-2019/</a>.
    </p>
    ...
    <p class="text-slate-300 mb-6">
      If a journalist is being playful, you can be playful. If they're being formal, do so too. And if you can't see a natural way to fit without bending the story, then you may as well just skip it.
    </p>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">The Difference Between Attention and Traction</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">The System Most Founders Are Missing</h3>
    ...
    <p class="text-slate-300 mb-6">
      Not to replace thinking. Not to automate relationships. But to remove friction.
    </p>

    <div class="bg-accent-violet/10 border border-accent-violet/30 rounded-lg p-6 my-8">
      <p class="text-slate-200 mb-4">
        <a href="/waitlist-signup" class="text-accent-blue hover:text-accent-violet font-semibold">Start your 7 day free trial today!</a>
      </p>
    </div>

    <h3 class="text-2xl font-semibold text-white mb-4">What Comes Next</h3>
  ...
  <section id="how-founders-get-press" class="mb-16">
    <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">Part 3: How Founders Can Get Press Without a PR Agency</h2>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">Why PR Agencies Often Don't Make Sense at This Stage</h3>
    ...
    <p class="text-slate-300 mb-6">
      No guarantees. No clear idea of what coverage they could actually land. Just vague promises about "building relationships" and "PR taking time".
    </p>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">Your Lived Experience Is the Asset</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">Stop Pitching Cold. Start Responding Instead.</h3>
    ...
    <p class="text-slate-300 mb-6">
      You stay human. You stay relevant. You stay fast.
    </p>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">Why Speed and Relevance Matter More Than Polish</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">PR as a Habit, Not a Hustle</h3>
    ...
    <div class="bg-accent-blue/10 border border-accent-blue/30 rounded-lg p-6 my-8">
      ...
      <p class="text-slate-200 mb-4">
        👉 <a href="/waitlist-signup" class="text-accent-blue hover:text-accent-violet font-semibold">Start your 7-day free trial of ContactJournalists.com now</a>. It's built by a founder who's been exactly where you are. We know you'll love it.
      </p>
    </div>
  </section>

  <section id="evergreen-pr" class="mb-16">
    <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">Part 4: Evergreen PR: How Press Coverage Drives Traffic for Years</h2>
    ...
    <p class="text-slate-300 mb-6">
      You're not renting attention. You're building something that lasts.
    </p>

    <h3 class="text-2xl font-semibold text-white mb-4">Small Brands Do This Better Than Big Ones</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">Why Lived Experience Ages Better Than Announcements</h3>
    ...
    <p class="text-slate-300 mb-6">
      Trends change. Human problems don't.
    </p>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">When Friction Becomes the Blueprint</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">PR as a Compounding Business Asset</h3>
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">Final Thought</h3>
    ...
    <p class="text-slate-300 mb-6">
      You don't need hype. You don't need to go viral. You don't need to shout.
    </p>
  ...
  <section id="common-questions" class="mb-16">
    <h2 class="text-3xl md:text-4xl font-bold text-white mb-6">PR for Founders: Common Questions</h2>

    <h3 class="text-2xl font-semibold text-white mb-4">Do founders need a PR agency?</h3>
    <p class="text-slate-300 mb-6">
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">How do startups get press coverage?</h3>
    <p class="text-slate-300 mb-6">
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">Is PR worth it for early-stage businesses?</h3>
    <p class="text-slate-300 mb-6">
    ...
    <h3 class="text-2xl font-semibold text-white mb-4">How long does PR take to work?</h3>
    <p class="text-slate-300 mb-6">
    ...
    <p class="text-slate-300 mb-6">
      The best way to contact journalists is when they've already asked to be contacted. That's what ContactJournalists.com are here for. <a href="/waitlist-signup" class="text-accent-blue hover:text-accent-violet font-semibold">Start you 7 day free trial now</a>.
    </p>
    <p class="text-slate-300 mb-6">
    ...
    <div class="bg-accent-blue/10 border border-accent-blue/30 rounded-lg p-6 my-8">
      <p class="text-slate-200 mb-4 text-center text-lg">
        See you on the inside of <a href="/waitlist-signup" class="text-accent-blue hover:text-accent-violet font-semibold">contactjournalists.com</a> - we can't wait to help you!
      </p>
    </div>
  </section>
</div>
`;
  ...
  const contentWithLinks = addInternalLinks(content);

  // Calculate word count
  const wordCount = contentWithLinks.replace(/<[^>]*>/g, " ").split(/\s+/).filter((w) => w.length > 0).length;
  ...
  // Set publish date to January 8th, 2025 (or 2026 if 2025 is in the past)
  // Using 2025 for now - user can adjust if needed
  const publishDate = "2025-01-08T00:00:00Z";
  const today = new Date();
  const publishDateObj = new Date(publishDate);
  const status = publishDateObj > today ? "scheduled" : "published";
  ...
  try {
    ...
    return { success: true, title, slug, status, publishDate };
  } catch (error: any) {
...
if (typeof window !== "undefined") {
  (window as any).createPRForFoundersBlog = createPRForFoundersBlog;
}
